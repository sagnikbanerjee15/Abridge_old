...
void readInEachChromosome (char *genome_filename, struct Whole_Genome_Sequence *whole_genome, char *chromosome)
{
	...
	{
		printf ("\nFreeing %d bytes" , ( strlen (whole_genome->reference_sequence_name[whole_genome->number_of_reference_sequences - 1]) + strlen (whole_genome->nucleotides[whole_genome->number_of_reference_sequences - 1]) ) / 1024);
