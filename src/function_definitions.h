...
void readInEachChromosome (char *genome_filename, struct Whole_Genome_Sequence *whole_genome, char *chromosome)
{
	...
	{
		free (whole_genome->reference_sequence_name[whole_genome->number_of_reference_sequences]);
		free (whole_genome->nucleotides[whole_genome->number_of_reference_sequences]);
	}
	whole_genome->number_of_reference_sequences = 0;
